...
Webflow.require('ix').init([
  ...
  {"slug":"scroll-fade","name":"Scroll Fade","value":{"style":{"opacity":0},"triggers":[{"type":"scroll","stepsA":[{"opacity":1,"transition":"opacity 800ms ease 0ms"}],"stepsB":[]}]}},
  {"slug":"float","name":"Float","value":{"style":{"x":"0px","y":"51px","z":"0px"},"triggers":[]}},
  {"slug":"new-interaction-2","name":"New Interaction 2","value":{"style":{},"triggers":[]}},
  {"slug":"float-trigger","name":"Float Trigger","value":{"style":{},"triggers":[{"type":"scroll","selector":".hover","loopA":true,"loopB":true,"offsetTop":"50%","offsetBot":"20%","stepsA":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"51px","z":"0px"}]}]}},
  {"slug":"tags-menu","name":"Tags Menu","value":{"style":{},"triggers":[{"type":"click","selector":".tags-drop","loopA":true,"loopB":true,"stepsA":[{"transition":"transform 150ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"transition":"transform 150ms ease 0ms","x":"0px","y":"-402px","z":"0px"}]}]}},
  {"slug":"tags-menu-origin","name":"Tags Menu Origin","value":{"style":{"x":"0px","y":"-402px","z":"0px"},"triggers":[]}},
  {"slug":"sign-in-appear","name":"Sign In Appear","value":{"style":{},"triggers":[{"type":"click","selector":".white-pane","loopA":true,"stepsA":[{"display":"block"}],"stepsB":[]}]}},
  {"slug":"email-sign-in-appear","name":"Email Sign In Appear","value":{"style":{},"triggers":[{"type":"click","selector":".email-sign-in-pane","loopA":true,"stepsA":[{"display":"block","opacity":1,"transition":"opacity 150ms ease 0ms"}],"stepsB":[]}]}},
  {"slug":"email-sign-in-disappear","name":"Email Sign In Disappear","value":{"style":{},"triggers":[{"type":"click","selector":".email-sign-in-pane","loopA":true,"stepsA":[{"display":"none"}],"stepsB":[]}]}},
  {"slug":"search-click","name":"Search Click","value":{"style":{},"triggers":[{"type":"click","selector":".searchbox_demo","loopA":true,"loopB":true,"stepsA":[{"display":"inline"}],"stepsB":[{"display":"none"}]}]}},
  {"slug":"hide-search","name":"Hide Search","value":{"style":{"display":"none"},"triggers":[]}},
  {"slug":"sign-in-disappear","name":"Sign In Disappear","value":{"style":{},"triggers":[{"type":"click","selector":".white-pane","loopA":true,"stepsA":[{"display":"none"}],"stepsB":[]}]}},
  {"slug":"prompt-pane-close","name":"Prompt Pane Close","value":{"style":{},"triggers":[{"type":"click","selector":".white-pane","loopA":true,"stepsA":[{"display":"none"}],"stepsB":[]}]}},
  {"slug":"prompt-pane-open","name":"Prompt Pane Open","value":{"style":{},"triggers":[{"type":"click","selector":".white-pane","loopA":true,"stepsA":[{"display":"block"}],"stepsB":[]}]}},
  {"slug":"newsletter-initially-hidden","name":"Newsletter Initially Hidden","value":{"style":{"x":"0px","y":"115px","z":"0px"},"triggers":[]}},
  {"slug":"newsletter-appear","name":"Newsletter Appear","value":{"style":{},"triggers":[{"type":"scroll","selector":".email-newsletter","loopA":true,"stepsA":[{"transition":"transform 300ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"success-visibility-none","name":"Success Visibility None","value":{"style":{"display":"none"},"triggers":[]}},
  {"slug":"close-tagline","name":"Close Tagline","value":{"style":{},"triggers":[{"type":"click","selector":".tagline-box","stepsA":[{"display":"none"}],"stepsB":[]}]}}
]);
